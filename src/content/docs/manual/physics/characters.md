...
On **Character Movement** you shape how it feels: **Move Speed**,
**Acceleration** and **Deceleration**, **Jump Speed**, **Max Jump Count** (set 2
for a double jump), **Air Control**, **Ground Friction**, **Gravity**, and
**Rotation Rate**. It also reports read-only **Grounded** and **Velocity**.
